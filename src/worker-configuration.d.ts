/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: fcb2c013ff07258a524aa3e13dfc1b7b)
// Runtime types generated with workerd@1.20260128.0 2026-01-14 nodejs_compat
declare namespace Cloudflare {
	interface DevEnv {
		CONFIG: KVNamespace;
		SHORTLINKS_CACHE: KVNamespace;
		DB: D1Database;
		VITE_SHORT_LINK_BASE_URL: "http://localhost:3001/";
	...
	interface ProdEnv {
		...
		SHORTLINKS_CACHE: KVNamespace;
		DB: D1Database;
		VITE_SHORT_LINK_BASE_URL: "https://poto.nz/";
		VITE_CF_TURNSTILE_SITE_KEY: "0x4AAAAAACJaHyskMo7xEMZJ";
		BETTER_AUTH_BASE_URL: "https://poto.nz/";
		CF_TURNSTILE_SECRET_KEY: string;
		BETTER_AUTH_SECRET: string;
		GOOGLE_OAUTH_CLIENT_ID: string;
		GOOGLE_OAUTH_CLIENT_SECRET: string;
	...
	interface Env {
		...
		SHORTLINKS_CACHE?: KVNamespace;
		DB?: D1Database;
		VITE_SHORT_LINK_BASE_URL?: "http://localhost:3001/" | "https://poto.nz/";
		VITE_CF_TURNSTILE_SITE_KEY?: "1x00000000000000000000AA" | "0x4AAAAAACJaHyskMo7xEMZJ";
		BETTER_AUTH_BASE_URL?: "http://localhost:3000/" | "https://poto.nz/";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_SHORT_LINK_BASE_URL" | "VITE_CF_TURNSTILE_SITE_KEY" | "BETTER_AUTH_BASE_URL" | "CF_TURNSTILE_SECRET_KEY" | "BETTER_AUTH_SECRET" | "GOOGLE_OAUTH_CLIENT_ID" | "GOOGLE_OAUTH_CLIENT_SECRET" | "MICROSOFT_CLIENT_ID" | "MICROSOFT_CLIENT_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET">> {}
}
